...
from AyushMusic.plugins.tools.clone import restart_bots
...
async def init():
    ...
    await Aayu.start()
    try:
        await Aayu.stream_call("https://te.legra.ph/file/29f784eb49d230ab62e9e.mp4")
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("AyushMusic").info("𝗦𝗧𝗢𝗣 𝗠𝗨𝗦𝗜𝗖🎻 𝗕𝗢𝗧..")
